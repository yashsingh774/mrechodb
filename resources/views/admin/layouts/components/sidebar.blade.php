<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ request()->is('admin/sections*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.section.index') }}"><i class="fas fa-filter"></i> <span>{{ __('Sections') }}</span></a></li>
            <li class="{{ request()->is('admin/banners*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.banner.index') }}"><i class="fas fa-image"></i> <span>{{ __('Banners') }}</span></a></li>
