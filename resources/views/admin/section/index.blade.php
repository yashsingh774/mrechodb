                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('admin.section.create') }}" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> {{ __('Add Section') }}</a>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="maintable" data-url="{{ route('admin.section.get-section') }}" data-status="{{ \App\Enums\Status::ACTIVE }}">
                                    <thead>
                                        <tr>
                                            <th>{{ __('ID') }}</th>
                                            <th>{{ __('Image') }}</th>
...
@section('scripts')
    ...
    <script src="{{ asset('js/section/index.js') }}"></script>
@endsection
